...
const CATEGORIES = [
  { id: "aircond",   emoji: "❄️", label: "Servis Aircond",   tagline: "Cuci, gas, tak sejuk" },
  { id: "plumbing",  emoji: "🔧", label: "Tukang Paip",       tagline: "Paip bocor, sinki tersumbat" },
  { id: "electrical",emoji: "⚡", label: "Wireman",           tagline: "Wiring, plug, lampu" },
  { id: "carmech",   emoji: "🚗", label: "Mekanik Kereta",    tagline: "Servis, brake, aircond kereta" },
  { id: "motor",     emoji: "🏍️", label: "Baiki Motor",       tagline: "Servis motor, tayar pancit" },
  { id: "cleaning",  emoji: "🧽", label: "Cuci Rumah",        tagline: "Cleaning, spring clean" },
  { id: "grasscut",  emoji: "🌿", label: "Potong Rumput",     tagline: "Landscape, trim pokok" },
  { id: "pest",      emoji: "🐜", label: "Kawalan Pest",      tagline: "Anai-anai, tikus, lipas" },
  { id: "reno",      emoji: "🧱", label: "Tukang Rumah",      tagline: "Reno, plaster, tiling" },
  { id: "painting",  emoji: "🎨", label: "Cat Rumah",         tagline: "Cat dalam & luar" },
  { id: "appliance", emoji: "🧊", label: "Baiki Appliance",   tagline: "Peti ais, mesin basuh" },
  { id: "locksmith", emoji: "🔑", label: "Tukang Kunci",      tagline: "Locked out? Kami datang" },
  { id: "cctv",      emoji: "📹", label: "CCTV & Antenna",    tagline: "Pasang & tuning" },
  { id: "furniture", emoji: "🪑", label: "Pasang Perabot",    tagline: "IKEA, wardrobe, katil" },
];
